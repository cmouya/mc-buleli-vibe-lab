...
- [`docs/m6.4-decisions.md`](m6.4-decisions.md) — Décisions M6.4 (humain) ; [`docs/m6.4-implementation-plan.md`](m6.4-implementation-plan.md) — M6.4 derived owned Completion/Progress (**ADR-019 Accepted** ; **M6.4 ADR/Decision Freeze COMPLETE** ; **implementation NOT STARTED** ; next = **C1**)
