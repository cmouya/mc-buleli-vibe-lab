...
- [`docs/m6.3-decisions.md`](m6.3-decisions.md) — Décisions M6.3 (humain) ; [`docs/m6.3-implementation-plan.md`](m6.3-implementation-plan.md) — M6.3 owned Evidence persist (**ADR-018 Accepted** ; **M6.3 ADR/Decision Freeze COMPLETE** ; **implementation NOT STARTED** ; next = **C1**)
...
4. Trajectoire : M0–M4 **Done** ; M5.1–M5.3 **Done** ; **ADR-016 Accepted** ; **M6.1 COMPLETE AND VALIDATED** (C1–C7) ; **ADR-017 Accepted** ; **M6.2 COMPLETE AND VALIDATED** (C1–C3 ; FINAL VALIDATION PASS) ; **ADR-018 Accepted** ; **M6.3 ADR/Decision Freeze COMPLETE** ; **M6.3 implementation NOT STARTED** ; next implementation checkpoint = **M6.3 C1** ; M5 **In progress** (RBAC détaillé différé). Pas de M4.5.
